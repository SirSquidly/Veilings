...
public class ModelVeilingDeftOutfit extends ModelVeilingDeft
{
    ...
    public ModelVeilingDeftOutfit()
    {
        ...
        outfit_torso.cubeList.add(new ModelBox(outfit_torso, 44, 16, -2.0F, -1.9F, -1.0F, 6, 2, 4, 0.01F, false));
        outfit_torso.cubeList.add(new ModelBox(outfit_torso, 0, 16, -1.0F, -2.0F, -0.5F, 4, 6, 3, 0.01F, false));

        outfit_armL = new ModelRenderer(this);
        outfit_armL.cubeList.add(new ModelBox(outfit_armL, 8, 33, 0.0F, -1.0F, -1.0F, 2, 7, 2, 0.01F, true));

        outfit_armR = new ModelRenderer(this);
        outfit_armR.cubeList.add(new ModelBox(outfit_armR, 0, 33, -2.0F, -1.0F, -1.0F, 2, 7, 2, 0.01F, false));

        poncho = new ModelRenderer(this);
        poncho.cubeList.add(new ModelBox(poncho, 30, 50, -6.0F, -6.5F, -2.5F, 12, 9, 5, 0.01F, false));

        outfit_legL = new ModelRenderer(this);
        outfit_legL.cubeList.add(new ModelBox(outfit_legL, 8, 45, -1.0F, 0.0F, -1.0F, 2, 6, 2, 0.01F, true));

        outfit_legR = new ModelRenderer(this);
        outfit_legR.cubeList.add(new ModelBox(outfit_legR, 0, 45, -1.0F, 0.0F, -1.0F, 2, 6, 2, 0.01F, false));
